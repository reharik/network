...
export const validateListContactsQuery = (() => { const _io0 = input => (undefined === input.dueOnly || "boolean" === typeof input.dueOnly) && (undefined === input.q || "string" === typeof input.q && 1 <= input.q.length); const _vo0 = (input, _path, _exceptionable = true) => [undefined === input.dueOnly || "boolean" === typeof input.dueOnly || _report(_exceptionable, {
        path: _path + ".dueOnly",
        expected: "(boolean | undefined)",
        value: input.dueOnly
...
export const validateUpsertDailyGoal = (() => { const _io0 = input => "number" === typeof input.dailyGoal && (__typia_transform__isTypeInt32._isTypeInt32(input.dailyGoal) && 0 <= input.dailyGoal && input.dailyGoal <= 500); const _vo0 = (input, _path, _exceptionable = true) => ["number" === typeof input.dailyGoal && (__typia_transform__isTypeInt32._isTypeInt32(input.dailyGoal) || _report(_exceptionable, {
