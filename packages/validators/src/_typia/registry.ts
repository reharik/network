...
export const validateUpsertContact = (data: unknown) => (() => { const _io0 = (input: any): boolean => (undefined === input.id || "string" === typeof input.id && __typia_transform__isFormatUuid._isFormatUuid(input.id)) && (undefined === input.userId || "string" === typeof input.userId && __typia_transform__isFormatUuid._isFormatUuid(input.userId)) && (undefined === input.firstName || "string" === typeof input.firstName && (1 <= input.firstName.length && input.firstName.length <= 200)) && (undefined === input.lastName || "string" === typeof input.lastName && (1 <= input.lastName.length && input.lastName.length <= 200)) && (undefined === input.preferredMethod || "object" === typeof input.preferredMethod && null !== input.preferredMethod && _io1(input.preferredMethod)) && (undefined === input.email || "string" === typeof input.email && __typia_transform__isFormatEmail._isFormatEmail(input.email)) && (undefined === input.phone || "string" === typeof input.phone) && (undefined === input.notes || "string" === typeof input.notes) && (undefined === input.suggestion || "string" === typeof input.suggestion) && (undefined === input.intervalDays || "number" === typeof input.intervalDays && (__typia_transform__isTypeInt32._isTypeInt32(input.intervalDays) && 1 <= input.intervalDays && input.intervalDays <= 365)) && (undefined === input.paused || "boolean" === typeof input.paused) && (undefined === input.snoozedUntil || "string" === typeof input.snoozedUntil && __typia_transform__isFormatDateTime._isFormatDateTime(input.snoozedUntil)) && (undefined === input.nextDueAt || "string" === typeof input.nextDueAt && __typia_transform__isFormatDateTime._isFormatDateTime(input.nextDueAt)) && (undefined === input.lastTouchedAt || "string" === typeof input.lastTouchedAt && __typia_transform__isFormatDateTime._isFormatDateTime(input.lastTouchedAt)) && (undefined === input.createdAt || "string" === typeof input.createdAt && __typia_transform__isFormatDateTime._isFormatDateTime(input.createdAt)) && (undefined === input.updatedAt || "string" === typeof input.updatedAt && __typia_transform__isFormatDateTime._isFormatDateTime(input.updatedAt)); const _io1 = (input: any): boolean => "string" === typeof input.key && "string" === typeof input.value && (undefined === input.display || "string" === typeof input.display) && (undefined === input.index || "number" === typeof input.index) && (undefined === input.deprecated || "boolean" === typeof input.deprecated) && true === input.__smart_enum_brand && true && true; const _vo0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => [undefined === input.id || "string" === typeof input.id && (__typia_transform__isFormatUuid._isFormatUuid(input.id) || _report(_exceptionable, {
        ...
        expected: "unknown",
        value: input.handle
    })].every((flag: boolean) => flag); const __is = (input: any): input is UpsertContactDTO => "object" === typeof input && null !== input && false === Array.isArray(input) && _io0(input); let errors: any; let _report: any; return (input: any): import("typia").IValidation<UpsertContactDTO> => {
    if (false === __is(input)) {
        errors = [];
...
export const validateListContactsQuery = (data: unknown) => (() => { const _io0 = (input: any): boolean => (undefined === input.dueOnly || "boolean" === typeof input.dueOnly) && (undefined === input.q || "string" === typeof input.q && 1 <= input.q.length); const _vo0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => [undefined === input.dueOnly || "boolean" === typeof input.dueOnly || _report(_exceptionable, {
        path: _path + ".dueOnly",
        expected: "(boolean | undefined)",
        value: input.dueOnly
        ...
        value: input.q
    })].every((flag: boolean) => flag); const __is = (input: any): input is ListContactsQueryDTO => "object" === typeof input && null !== input && false === Array.isArray(input) && _io0(input); let errors: any; let _report: any; return (input: any): import("typia").IValidation<ListContactsQueryDTO> => {
    if (false === __is(input)) {
        errors = [];
        _report = (__typia_transform__validateReport._validateReport as any)(errors);
        ((input: any, _path: string, _exceptionable: boolean = true) => ("object" === typeof input && null !== input && false === Array.isArray(input) || _report(true, {
...
export const validateCreateTouch = (data: unknown) => (() => { const _io0 = (input: any): boolean => "string" === typeof input.contactId && __typia_transform__isFormatUuid._isFormatUuid(input.contactId) && ("object" === typeof input.method && null !== input.method && _io1(input.method)) && (undefined === input.message || "string" === typeof input.message) && (undefined === input.outcome || "string" === typeof input.outcome); const _io1 = (input: any): boolean => "string" === typeof input.key && "string" === typeof input.value && (undefined === input.display || "string" === typeof input.display) && (undefined === input.index || "number" === typeof input.index) && (undefined === input.deprecated || "boolean" === typeof input.deprecated) && true === input.__smart_enum_brand && true && true; const _vo0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ["string" === typeof input.contactId && (__typia_transform__isFormatUuid._isFormatUuid(input.contactId) || _report(_exceptionable, {
        ...
        expected: "unknown",
        value: input.handle
    })].every((flag: boolean) => flag); const __is = (input: any): input is CreateTouchDTO => "object" === typeof input && null !== input && _io0(input); let errors: any; let _report: any; return (input: any): import("typia").IValidation<CreateTouchDTO> => {
    if (false === __is(input)) {
        errors = [];
        _report = (__typia_transform__validateReport._validateReport as any)(errors);
...
export const validatePlanQuery = (data: unknown) => (() => { const _io0 = (input: any): boolean => undefined === input.date || "string" === typeof input.date && __typia_transform__isFormatDateTime._isFormatDateTime(input.date); const _vo0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => [undefined === input.date || "string" === typeof input.date && (__typia_transform__isFormatDateTime._isFormatDateTime(input.date) || _report(_exceptionable, {
        path: _path + ".date",
        expected: "string & Format<\"date-time\">",
        value: input.date
    })) || _report(_exceptionable, {
        ...
        expected: "((string & Format<\"date-time\">) | undefined)",
        value: input.date
    })].every((flag: boolean) => flag); const __is = (input: any): input is PlanQueryDTO => "object" === typeof input && null !== input && false === Array.isArray(input) && _io0(input); let errors: any; let _report: any; return (input: any): import("typia").IValidation<PlanQueryDTO> => {
    if (false === __is(input)) {
        errors = [];
        _report = (__typia_transform__validateReport._validateReport as any)(errors);
        ((input: any, _path: string, _exceptionable: boolean = true) => ("object" === typeof input && null !== input && false === Array.isArray(input) || _report(true, {
...
export const validateUpsertDailyGoal = (data: unknown) => (() => { const _io0 = (input: any): boolean => "number" === typeof input.dailyGoal && (__typia_transform__isTypeInt32._isTypeInt32(input.dailyGoal) && 0 <= input.dailyGoal && input.dailyGoal <= 500); const _vo0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ["number" === typeof input.dailyGoal && (__typia_transform__isTypeInt32._isTypeInt32(input.dailyGoal) || _report(_exceptionable, {
        ...
        value: input.dailyGoal
    })].every((flag: boolean) => flag); const __is = (input: any): input is UpsertDailyGoalDTO => "object" === typeof input && null !== input && _io0(input); let errors: any; let _report: any; return (input: any): import("typia").IValidation<UpsertDailyGoalDTO> => {
    if (false === __is(input)) {
        errors = [];
        _report = (__typia_transform__validateReport._validateReport as any)(errors);
        ((input: any, _path: string, _exceptionable: boolean = true) => ("object" === typeof input && null !== input || _report(true, {
