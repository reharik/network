...
export const validateUpdateContact = (data) => (() => { const _io0 = input => (undefined === input.id || "string" === typeof input.id && __typia_transform__isFormatUuid._isFormatUuid(input.id)) && (undefined === input.userId || "string" === typeof input.userId && __typia_transform__isFormatUuid._isFormatUuid(input.userId)) && (undefined === input.firstName || "string" === typeof input.firstName && (1 <= input.firstName.length && input.firstName.length <= 200)) && (undefined === input.lastName || "string" === typeof input.lastName && (1 <= input.lastName.length && input.lastName.length <= 200)) && (undefined === input.email || "string" === typeof input.email && __typia_transform__isFormatEmail._isFormatEmail(input.email)) && (undefined === input.intervalDays || "number" === typeof input.intervalDays && (__typia_transform__isTypeInt32._isTypeInt32(input.intervalDays) && 1 <= input.intervalDays && input.intervalDays <= 365)) && (undefined === input.snoozedUntil || "string" === typeof input.snoozedUntil && __typia_transform__isFormatDateTime._isFormatDateTime(input.snoozedUntil)) && (undefined === input.nextDueAt || "string" === typeof input.nextDueAt && __typia_transform__isFormatDateTime._isFormatDateTime(input.nextDueAt)) && (undefined === input.lastTouchedAt || "string" === typeof input.lastTouchedAt && __typia_transform__isFormatDateTime._isFormatDateTime(input.lastTouchedAt)) && (undefined === input.createdAt || "string" === typeof input.createdAt && __typia_transform__isFormatDateTime._isFormatDateTime(input.createdAt)) && (undefined === input.updatedAt || "string" === typeof input.updatedAt && __typia_transform__isFormatDateTime._isFormatDateTime(input.updatedAt)) && (undefined === input.preferredMethod || "object" === typeof input.preferredMethod && null !== input.preferredMethod && _io1(input.preferredMethod)) && (undefined === input.phone || "string" === typeof input.phone) && (undefined === input.notes || "string" === typeof input.notes) && (undefined === input.suggestion || "string" === typeof input.suggestion) && (undefined === input.paused || "boolean" === typeof input.paused); const _io1 = input => "string" === typeof input.key && "string" === typeof input.value && (undefined === input.display || "string" === typeof input.display) && (undefined === input.index || "number" === typeof input.index) && (undefined === input.deprecated || "boolean" === typeof input.deprecated) && true === input.__smart_enum_brand && (undefined === input.__smart_enum_type || "string" === typeof input.__smart_enum_type) && true && true; const _vo0 = (input, _path, _exceptionable = true) => [undefined === input.id || "string" === typeof input.id && (__typia_transform__isFormatUuid._isFormatUuid(input.id) || _report(_exceptionable, {
        path: _path + ".id",
        expected: "string & Format<\"uuid\">",
        value: input.id
    })) || _report(_exceptionable, {
...
export const validateInsertContact = (data) => (() => { const _io0 = input => "string" === typeof input.userId && __typia_transform__isFormatUuid._isFormatUuid(input.userId) && ("string" === typeof input.firstName && (1 <= input.firstName.length && input.firstName.length <= 200)) && ("string" === typeof input.lastName && (1 <= input.lastName.length && input.lastName.length <= 200)) && (undefined === input.email || "string" === typeof input.email && __typia_transform__isFormatEmail._isFormatEmail(input.email)) && ("number" === typeof input.intervalDays && (__typia_transform__isTypeInt32._isTypeInt32(input.intervalDays) && 1 <= input.intervalDays && input.intervalDays <= 365)) && (undefined === input.snoozedUntil || "string" === typeof input.snoozedUntil && __typia_transform__isFormatDateTime._isFormatDateTime(input.snoozedUntil)) && (undefined === input.nextDueAt || "string" === typeof input.nextDueAt && __typia_transform__isFormatDateTime._isFormatDateTime(input.nextDueAt)) && (undefined === input.lastTouchedAt || "string" === typeof input.lastTouchedAt && __typia_transform__isFormatDateTime._isFormatDateTime(input.lastTouchedAt)) && (undefined === input.createdAt || "string" === typeof input.createdAt && __typia_transform__isFormatDateTime._isFormatDateTime(input.createdAt)) && (undefined === input.updatedAt || "string" === typeof input.updatedAt && __typia_transform__isFormatDateTime._isFormatDateTime(input.updatedAt)) && ("object" === typeof input.preferredMethod && null !== input.preferredMethod && _io1(input.preferredMethod)) && (undefined === input.phone || "string" === typeof input.phone) && (undefined === input.notes || "string" === typeof input.notes) && "string" === typeof input.suggestion && (undefined === input.paused || "boolean" === typeof input.paused); const _io1 = input => "string" === typeof input.key && "string" === typeof input.value && (undefined === input.display || "string" === typeof input.display) && (undefined === input.index || "number" === typeof input.index) && (undefined === input.deprecated || "boolean" === typeof input.deprecated) && true === input.__smart_enum_brand && (undefined === input.__smart_enum_type || "string" === typeof input.__smart_enum_type) && true && true; const _vo0 = (input, _path, _exceptionable = true) => ["string" === typeof input.userId && (__typia_transform__isFormatUuid._isFormatUuid(input.userId) || _report(_exceptionable, {
        path: _path + ".userId",
        expected: "string & Format<\"uuid\">",
        value: input.userId
    })) || _report(_exceptionable, {
...
export const validateInsertUser = (data) => (() => { const _io0 = input => (undefined === input.firstName || "string" === typeof input.firstName) && (undefined === input.lastName || "string" === typeof input.lastName) && ("string" === typeof input.email && __typia_transform__isFormatEmail._isFormatEmail(input.email)) && (undefined === input.createdAt || "string" === typeof input.createdAt && __typia_transform__isFormatDateTime._isFormatDateTime(input.createdAt)) && ("number" === typeof input.dailyGoal && (__typia_transform__isTypeInt32._isTypeInt32(input.dailyGoal) && 0 <= input.dailyGoal && input.dailyGoal <= 500)) && ("string" === typeof input.lastLoginAt && __typia_transform__isFormatDateTime._isFormatDateTime(input.lastLoginAt)) && "string" === typeof input.passwordHash; const _vo0 = (input, _path, _exceptionable = true) => [undefined === input.firstName || "string" === typeof input.firstName || _report(_exceptionable, {
        path: _path + ".firstName",
        expected: "(string | undefined)",
        value: input.firstName
    }), undefined === input.lastName || "string" === typeof input.lastName || _report(_exceptionable, {
