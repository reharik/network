...
export const validateUpsertContact = (data) => (() => {
    ...
    const _vo1 = (input, _path, _exceptionable = true) => ["string" === typeof input.key || _report(_exceptionable, {
            path: _path + ".key",
            expected: "string",
            value: input.key
...
export const validateListContactsQuery = (data) => (() => {
    const _io0 = (input) => (undefined === input.dueOnly || "boolean" === typeof input.dueOnly) && (undefined === input.q || "string" === typeof input.q && 1 <= input.q.length);
    const _vo0 = (input, _path, _exceptionable = true) => [undefined === input.dueOnly || "boolean" === typeof input.dueOnly || _report(_exceptionable, {
            path: _path + ".dueOnly",
            expected: "(boolean | undefined)",
            value: input.dueOnly
...
export const validateCreateTouch = (data) => (() => {
    const _io0 = (input) => "string" === typeof input.contactId && __typia_transform__isFormatUuid._isFormatUuid(input.contactId) && ("object" === typeof input.method && null !== input.method && _io1(input.method)) && (undefined === input.message || "string" === typeof input.message) && (undefined === input.outcome || "string" === typeof input.outcome);
    const _io1 = (input) => "string" === typeof input.key && "string" === typeof input.value && (undefined === input.display || "string" === typeof input.display) && (undefined === input.index || "number" === typeof input.index) && (undefined === input.deprecated || "boolean" === typeof input.deprecated) && true === input.__smart_enum_brand && true && true;
    const _vo0 = (input, _path, _exceptionable = true) => ["string" === typeof input.contactId && (__typia_transform__isFormatUuid._isFormatUuid(input.contactId) || _report(_exceptionable, {
...
export const validatePlanQuery = (data) => (() => {
    const _io0 = (input) => undefined === input.date || "string" === typeof input.date && __typia_transform__isFormatDateTime._isFormatDateTime(input.date);
    const _vo0 = (input, _path, _exceptionable = true) => [undefined === input.date || "string" === typeof input.date && (__typia_transform__isFormatDateTime._isFormatDateTime(input.date) || _report(_exceptionable, {
            path: _path + ".date",
            expected: "string & Format<\"date-time\">",
            value: input.date
        })) || _report(_exceptionable, {
...
export const validateUpsertDailyGoal = (data) => (() => {
    const _io0 = (input) => "number" === typeof input.dailyGoal && (__typia_transform__isTypeInt32._isTypeInt32(input.dailyGoal) && 0 <= input.dailyGoal && input.dailyGoal <= 500);
    const _vo0 = (input, _path, _exceptionable = true) => ["number" === typeof input.dailyGoal && (__typia_transform__isTypeInt32._isTypeInt32(input.dailyGoal) || _report(_exceptionable, {
