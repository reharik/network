...
import type { Contact, CreateTouchInput, SignupCredentials, Touch, UpdateContact, UpdateUser, User, } from "../../types/entities";
...
export const validateTouch = (data: unknown) => (() => { const _io0 = (input: any): boolean => "string" === typeof input.id && __typia_transform__isFormatUuid._isFormatUuid(input.id) && ("string" === typeof input.userId && __typia_transform__isFormatUuid._isFormatUuid(input.userId)) && ("string" === typeof input.contactId && __typia_transform__isFormatUuid._isFormatUuid(input.contactId)) && (undefined === input.fromContactNow || "boolean" === typeof input.fromContactNow) && (undefined === input.createdAt || "string" === typeof input.createdAt && __typia_transform__isFormatDateTime._isFormatDateTime(input.createdAt)) && ("object" === typeof input.method && null !== input.method && _io1(input.method)) && (undefined === input.message || "string" === typeof input.message) && (undefined === input.outcome || "string" === typeof input.outcome); const _io1 = (input: any): boolean => "string" === typeof input.key && "string" === typeof input.value && (undefined === input.display || "string" === typeof input.display) && (undefined === input.index || "number" === typeof input.index) && (undefined === input.deprecated || "boolean" === typeof input.deprecated) && true === input.__smart_enum_brand && (undefined === input.__smart_enum_type || "string" === typeof input.__smart_enum_type) && true && true; const _vo0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ["string" === typeof input.id && (__typia_transform__isFormatUuid._isFormatUuid(input.id) || _report(_exceptionable, {
        ...
        expected: "(string & Format<\"uuid\">)",
        value: input.contactId
    }), undefined === input.fromContactNow || "boolean" === typeof input.fromContactNow || _report(_exceptionable, {
        path: _path + ".fromContactNow",
        expected: "(boolean | undefined)",
        value: input.fromContactNow
    }), undefined === input.createdAt || "string" === typeof input.createdAt && (__typia_transform__isFormatDateTime._isFormatDateTime(input.createdAt) || _report(_exceptionable, {
        path: _path + ".createdAt",
        expected: "string & Format<\"date-time\">",
        value: input.createdAt
...
export const validateCreateTouchInput = (data: unknown) => (() => { const _io0 = (input: any): boolean => "string" === typeof input.contactId && __typia_transform__isFormatUuid._isFormatUuid(input.contactId) && ("object" === typeof input.method && null !== input.method && _io1(input.method)) && (undefined === input.message || "string" === typeof input.message) && (undefined === input.outcome || "string" === typeof input.outcome) && (undefined === input.fromContactNow || "boolean" === typeof input.fromContactNow); const _io1 = (input: any): boolean => "string" === typeof input.key && "string" === typeof input.value && (undefined === input.display || "string" === typeof input.display) && (undefined === input.index || "number" === typeof input.index) && (undefined === input.deprecated || "boolean" === typeof input.deprecated) && true === input.__smart_enum_brand && (undefined === input.__smart_enum_type || "string" === typeof input.__smart_enum_type) && true && true; const _vo0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ["string" === typeof input.contactId && (__typia_transform__isFormatUuid._isFormatUuid(input.contactId) || _report(_exceptionable, {
        path: _path + ".contactId",
        expected: "string & Format<\"uuid\">",
        value: input.contactId
    })) || _report(_exceptionable, {
        ...
        expected: "unknown",
        value: input.handle
    })].every((flag: boolean) => flag); const __is = (input: any): input is CreateTouchInput => "object" === typeof input && null !== input && _io0(input); let errors: any; let _report: any; return (input: any): import("typia").IValidation<CreateTouchInput> => {
    if (false === __is(input)) {
        errors = [];
        _report = (__typia_transform__validateReport._validateReport as any)(errors);
        ((input: any, _path: string, _exceptionable: boolean = true) => ("object" === typeof input && null !== input || _report(true, {
            path: _path + "",
            expected: "CreateTouchInput",
            value: input
        })) && _vo0(input, _path + "", true) || _report(true, {
            path: _path + "",
            expected: "CreateTouchInput",
...
export const validateUser = (data: unknown) => (() => { const _io0 = (input: any): boolean => "string" === typeof input.email && __typia_transform__isFormatEmail._isFormatEmail(input.email) && ("number" === typeof input.dailyGoal && (__typia_transform__isTypeInt32._isTypeInt32(input.dailyGoal) && 0 <= input.dailyGoal && input.dailyGoal <= 500)) && (undefined === input.defaultContactMessage || "string" === typeof input.defaultContactMessage) && (undefined === input.defaultIntervalDays || "number" === typeof input.defaultIntervalDays) && (undefined === input.defaultPreferredMethod || "string" === typeof input.defaultPreferredMethod) && (undefined === input.createdAt || "string" === typeof input.createdAt && __typia_transform__isFormatDateTime._isFormatDateTime(input.createdAt)) && ("string" === typeof input.lastLoginAt && __typia_transform__isFormatDateTime._isFormatDateTime(input.lastLoginAt)) && "string" === typeof input.id && (undefined === input.firstName || "string" === typeof input.firstName) && (undefined === input.lastName || "string" === typeof input.lastName) && "string" === typeof input.passwordHash && (undefined === input.phone || "string" === typeof input.phone); const _vo0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ["string" === typeof input.email && (__typia_transform__isFormatEmail._isFormatEmail(input.email) || _report(_exceptionable, {
        path: _path + ".email",
        expected: "string & Format<\"email\">",
        value: input.email
    })) || _report(_exceptionable, {
        ...
        value: input.dailyGoal
    }), undefined === input.defaultContactMessage || "string" === typeof input.defaultContactMessage || _report(_exceptionable, {
        path: _path + ".defaultContactMessage",
        expected: "(string | undefined)",
        value: input.defaultContactMessage
    }), undefined === input.defaultIntervalDays || "number" === typeof input.defaultIntervalDays || _report(_exceptionable, {
        path: _path + ".defaultIntervalDays",
        expected: "(number | undefined)",
        value: input.defaultIntervalDays
    }), undefined === input.defaultPreferredMethod || "string" === typeof input.defaultPreferredMethod || _report(_exceptionable, {
        path: _path + ".defaultPreferredMethod",
        expected: "(string | undefined)",
        value: input.defaultPreferredMethod
    }), undefined === input.createdAt || "string" === typeof input.createdAt && (__typia_transform__isFormatDateTime._isFormatDateTime(input.createdAt) || _report(_exceptionable, {
        path: _path + ".createdAt",
        expected: "string & Format<\"date-time\">",
        value: input.createdAt
...
export const validateInsertUser = (data: unknown) => (() => { const _io0 = (input: any): boolean => "string" === typeof input.email && __typia_transform__isFormatEmail._isFormatEmail(input.email) && (undefined === input.firstName || "string" === typeof input.firstName) && (undefined === input.lastName || "string" === typeof input.lastName) && (undefined === input.createdAt || "string" === typeof input.createdAt && __typia_transform__isFormatDateTime._isFormatDateTime(input.createdAt)) && (undefined === input.phone || "string" === typeof input.phone) && ("number" === typeof input.dailyGoal && (__typia_transform__isTypeInt32._isTypeInt32(input.dailyGoal) && 0 <= input.dailyGoal && input.dailyGoal <= 500)) && (undefined === input.defaultContactMessage || "string" === typeof input.defaultContactMessage) && (undefined === input.defaultIntervalDays || "number" === typeof input.defaultIntervalDays) && (undefined === input.defaultPreferredMethod || "string" === typeof input.defaultPreferredMethod) && ("string" === typeof input.lastLoginAt && __typia_transform__isFormatDateTime._isFormatDateTime(input.lastLoginAt)) && "string" === typeof input.passwordHash; const _vo0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ["string" === typeof input.email && (__typia_transform__isFormatEmail._isFormatEmail(input.email) || _report(_exceptionable, {
        path: _path + ".email",
        expected: "string & Format<\"email\">",
        value: input.email
    })) || _report(_exceptionable, {
...
export const validateSignupCredentials = (data: unknown) => (() => { const _io0 = (input: any): boolean => "string" === typeof input.email && __typia_transform__isFormatEmail._isFormatEmail(input.email) && ("string" === typeof input.password && 8 <= input.password.length) && (undefined === input.firstName || "string" === typeof input.firstName && input.firstName.length <= 100) && (undefined === input.lastName || "string" === typeof input.lastName && input.lastName.length <= 100); const _vo0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ["string" === typeof input.email && (__typia_transform__isFormatEmail._isFormatEmail(input.email) || _report(_exceptionable, {
        path: _path + ".email",
        expected: "string & Format<\"email\">",
        value: input.email
    })) || _report(_exceptionable, {
        ...
        expected: "(string & Format<\"email\">)",
        value: input.email
    }), "string" === typeof input.password && (8 <= input.password.length || _report(_exceptionable, {
        path: _path + ".password",
        ...
        expected: "(string & MinLength<8>)",
        value: input.password
    }), undefined === input.firstName || "string" === typeof input.firstName && (input.firstName.length <= 100 || _report(_exceptionable, {
        path: _path + ".firstName",
        expected: "string & MaxLength<100>",
        value: input.firstName
    })) || _report(_exceptionable, {
        path: _path + ".firstName",
        expected: "((string & MaxLength<100>) | undefined)",
        value: input.firstName
    }), undefined === input.lastName || "string" === typeof input.lastName && (input.lastName.length <= 100 || _report(_exceptionable, {
        path: _path + ".lastName",
        expected: "string & MaxLength<100>",
        value: input.lastName
    })) || _report(_exceptionable, {
        ...
        expected: "((string & MaxLength<100>) | undefined)",
        value: input.lastName
    })].every((flag: boolean) => flag); const __is = (input: any): input is SignupCredentials => "object" === typeof input && null !== input && _io0(input); let errors: any; let _report: any; return (input: any): import("typia").IValidation<SignupCredentials> => {
    if (false === __is(input)) {
        errors = [];
        _report = (__typia_transform__validateReport._validateReport as any)(errors);
        ((input: any, _path: string, _exceptionable: boolean = true) => ("object" === typeof input && null !== input || _report(true, {
            path: _path + "",
            expected: "SignupCredentials",
            value: input
        })) && _vo0(input, _path + "", true) || _report(true, {
            path: _path + "",
            expected: "SignupCredentials",
