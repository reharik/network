...
export const validateContact = (data: unknown) =>
  (() => {
    const _io0 = (input: any): boolean =>
      ...
      (undefined === input.lastTouchedAt ||
        ('string' === typeof input.lastTouchedAt &&
          __typia_transform__isFormatDateTime._isFormatDateTime(input.lastTouchedAt))) &&
      (undefined === input.createdAt ||
        ('string' === typeof input.createdAt &&
          __typia_transform__isFormatDateTime._isFormatDateTime(input.createdAt))) &&
      (undefined === input.updatedAt ||
    ...
    const _io1 = (input: any): boolean =>
      ...
      (undefined === input.index || 'number' === typeof input.index) &&
      (undefined === input.deprecated || 'boolean' === typeof input.deprecated) &&
      true === input.__smart_enum_brand &&
      (undefined === input.__smart_enum_type || 'string' === typeof input.__smart_enum_type) &&
      true &&
      true;
    const _vo0 = (input: any, _path: string, _exceptionable: boolean = true): boolean =>
      [
        ...
        ((('object' === typeof input.preferredMethod && null !== input.preferredMethod) ||
          _report(_exceptionable, {
        ...
        undefined === input.paused ||
          'boolean' === typeof input.paused ||
          _report(_exceptionable, {
            path: _path + '.paused',
    ...
    const _vo1 = (input: any, _path: string, _exceptionable: boolean = true): boolean =>
      [
        ...
        undefined === input.index ||
          'number' === typeof input.index ||
          _report(_exceptionable, {
            path: _path + '.index',
        ...
        undefined === input.__smart_enum_type ||
          'string' === typeof input.__smart_enum_type ||
          _report(_exceptionable, {
    ...
    const __is = (input: any): input is Contact =>
      'object' === typeof input && null !== input && _io0(input);
    let errors: any;
    let _report: any;
    return (input: any): import('typia').IValidation<Contact> => {
      if (false === __is(input)) {
        errors = [];
  ...
  (() => {
    const _io0 = (input: any): boolean =>
      ...
      (undefined === input.userId ||
        ('string' === typeof input.userId &&
          __typia_transform__isFormatUuid._isFormatUuid(input.userId))) &&
      (undefined === input.firstName ||
        ('string' === typeof input.firstName &&
          1 <= input.firstName.length &&
          input.firstName.length <= 200)) &&
      (undefined === input.lastName ||
        ('string' === typeof input.lastName &&
          1 <= input.lastName.length &&
          input.lastName.length <= 200)) &&
      (undefined === input.email ||
    ...
    const __is = (input: any): input is UpdateContact =>
      'object' === typeof input && null !== input && false === Array.isArray(input) && _io0(input);
    let errors: any;
    let _report: any;
    return (input: any): import('typia').IValidation<UpdateContact> => {
      if (false === __is(input)) {
        errors = [];
        _report = (__typia_transform__validateReport._validateReport as any)(errors);
        ((input: any, _path: string, _exceptionable: boolean = true) =>
...
export const validateInsertContact = (data: unknown) =>
  (() => {
    const _io0 = (input: any): boolean =>
      (undefined === input.email ||
        ('string' === typeof input.email &&
    ...
    const __is = (input: any): input is Omit<Contact, 'id'> =>
      'object' === typeof input && null !== input && _io0(input);
    let errors: any;
    let _report: any;
    return (input: any): import('typia').IValidation<Omit<Contact, 'id'>> => {
      if (false === __is(input)) {
        errors = [];
        _report = (__typia_transform__validateReport._validateReport as any)(errors);
        ((input: any, _path: string, _exceptionable: boolean = true) =>
...
export const validateTouch = (data: unknown) =>
  (() => {
    const _io0 = (input: any): boolean =>
      'string' === typeof input.id &&
      __typia_transform__isFormatUuid._isFormatUuid(input.id) &&
      ...
      __typia_transform__isFormatUuid._isFormatUuid(input.contactId) &&
      (undefined === input.fromContactNow || 'boolean' === typeof input.fromContactNow) &&
      (undefined === input.createdAt ||
        ('string' === typeof input.createdAt &&
          __typia_transform__isFormatDateTime._isFormatDateTime(input.createdAt))) &&
      'object' === typeof input.method &&
      null !== input.method &&
      _io1(input.method) &&
      (undefined === input.message || 'string' === typeof input.message) &&
      (undefined === input.outcome || 'string' === typeof input.outcome);
    const _io1 = (input: any): boolean =>
      'string' === typeof input.key &&
      'string' === typeof input.value &&
      (undefined === input.display || 'string' === typeof input.display) &&
    ...
    const _vo0 = (input: any, _path: string, _exceptionable: boolean = true): boolean =>
      [
        ...
        undefined === input.fromContactNow ||
          'boolean' === typeof input.fromContactNow ||
          _report(_exceptionable, {
        ...
        ((('object' === typeof input.method && null !== input.method) ||
          _report(_exceptionable, {
            path: _path + '.method',
            expected: 'EnumItem<__object, ContactMethodItem>',
            value: input.method,
          })) &&
          _vo1(input.method, _path + '.method', true && _exceptionable)) ||
          _report(_exceptionable, {
            path: _path + '.method',
            expected: 'EnumItem<__object, ContactMethodItem>',
            value: input.method,
          }),
        undefined === input.message ||
        ...
        undefined === input.outcome ||
          'string' === typeof input.outcome ||
          _report(_exceptionable, {
            path: _path + '.outcome',
            expected: '(string | undefined)',
            value: input.outcome,
    ...
    const __is = (input: any): input is Touch =>
      'object' === typeof input && null !== input && _io0(input);
    let errors: any;
    let _report: any;
    return (input: any): import('typia').IValidation<Touch> => {
      if (false === __is(input)) {
        errors = [];
        _report = (__typia_transform__validateReport._validateReport as any)(errors);
        ((input: any, _path: string, _exceptionable: boolean = true) =>
...
export const validateInsertTouch = (data: unknown) =>
  (() => {
    const _io0 = (input: any): boolean =>
      'string' === typeof input.userId &&
      __typia_transform__isFormatUuid._isFormatUuid(input.userId) &&
    ...
    const __is = (input: any): input is Omit<Touch, 'id'> =>
      'object' === typeof input && null !== input && _io0(input);
    let errors: any;
    let _report: any;
    return (input: any): import('typia').IValidation<Omit<Touch, 'id'>> => {
      if (false === __is(input)) {
        errors = [];
        _report = (__typia_transform__validateReport._validateReport as any)(errors);
        ((input: any, _path: string, _exceptionable: boolean = true) =>
...
export const validateCreateTouchInput = (data: unknown) =>
  (() => {
    const _io0 = (input: any): boolean =>
      'string' === typeof input.contactId &&
      __typia_transform__isFormatUuid._isFormatUuid(input.contactId) &&
    ...
    const __is = (input: any): input is CreateTouchInput =>
      'object' === typeof input && null !== input && _io0(input);
    let errors: any;
    let _report: any;
    return (input: any): import('typia').IValidation<CreateTouchInput> => {
      if (false === __is(input)) {
        errors = [];
        _report = (__typia_transform__validateReport._validateReport as any)(errors);
        ((input: any, _path: string, _exceptionable: boolean = true) =>
...
export const validateUser = (data: unknown) =>
  (() => {
    const _io0 = (input: any): boolean =>
      'string' === typeof input.email &&
      __typia_transform__isFormatEmail._isFormatEmail(input.email) &&
      'number' === typeof input.dailyGoal &&
      __typia_transform__isTypeInt32._isTypeInt32(input.dailyGoal) &&
      0 <= input.dailyGoal &&
      input.dailyGoal <= 500 &&
      (undefined === input.defaultContactMessage ||
        'string' === typeof input.defaultContactMessage) &&
      (undefined === input.defaultIntervalDays || 'number' === typeof input.defaultIntervalDays) &&
      (undefined === input.defaultPreferredMethod ||
        'string' === typeof input.defaultPreferredMethod) &&
      (undefined === input.createdAt ||
        ('string' === typeof input.createdAt &&
          __typia_transform__isFormatDateTime._isFormatDateTime(input.createdAt))) &&
      'string' === typeof input.lastLoginAt &&
      __typia_transform__isFormatDateTime._isFormatDateTime(input.lastLoginAt) &&
      'string' === typeof input.id &&
      (undefined === input.firstName || 'string' === typeof input.firstName) &&
      (undefined === input.lastName || 'string' === typeof input.lastName) &&
    ...
    const _vo0 = (input: any, _path: string, _exceptionable: boolean = true): boolean =>
      [
        ...
        undefined === input.defaultIntervalDays ||
          'number' === typeof input.defaultIntervalDays ||
          _report(_exceptionable, {
    ...
    let errors: any;
    let _report: any;
    return (input: any): import('typia').IValidation<User> => {
      if (false === __is(input)) {
        errors = [];
        _report = (__typia_transform__validateReport._validateReport as any)(errors);
        ((input: any, _path: string, _exceptionable: boolean = true) =>
  ...
  (() => {
    const _io0 = (input: any): boolean =>
      ...
      (undefined === input.createdAt ||
        ('string' === typeof input.createdAt &&
          __typia_transform__isFormatDateTime._isFormatDateTime(input.createdAt))) &&
      (undefined === input.lastLoginAt ||
        ('string' === typeof input.lastLoginAt &&
          __typia_transform__isFormatDateTime._isFormatDateTime(input.lastLoginAt))) &&
      (undefined === input.id || 'string' === typeof input.id) &&
      (undefined === input.firstName || 'string' === typeof input.firstName) &&
      (undefined === input.lastName || 'string' === typeof input.lastName) &&
      (undefined === input.passwordHash || 'string' === typeof input.passwordHash) &&
      (undefined === input.phone || 'string' === typeof input.phone);
    const _vo0 = (input: any, _path: string, _exceptionable: boolean = true): boolean =>
      [
        undefined === input.email ||
    ...
    const __is = (input: any): input is UpdateUser =>
      'object' === typeof input && null !== input && false === Array.isArray(input) && _io0(input);
    let errors: any;
    let _report: any;
    return (input: any): import('typia').IValidation<UpdateUser> => {
      if (false === __is(input)) {
        errors = [];
        _report = (__typia_transform__validateReport._validateReport as any)(errors);
        ((input: any, _path: string, _exceptionable: boolean = true) =>
...
export const validateInsertUser = (data: unknown) =>
  (() => {
    const _io0 = (input: any): boolean =>
      'string' === typeof input.email &&
      __typia_transform__isFormatEmail._isFormatEmail(input.email) &&
    ...
    const __is = (input: any): input is Omit<User, 'id'> =>
      'object' === typeof input && null !== input && _io0(input);
    let errors: any;
    let _report: any;
    return (input: any): import('typia').IValidation<Omit<User, 'id'>> => {
      if (false === __is(input)) {
        errors = [];
        _report = (__typia_transform__validateReport._validateReport as any)(errors);
        ((input: any, _path: string, _exceptionable: boolean = true) =>
...
export const validateSignupCredentials = (data: unknown) =>
  (() => {
    const _io0 = (input: any): boolean =>
      ...
      8 <= input.password.length &&
      (undefined === input.firstName ||
        ('string' === typeof input.firstName && input.firstName.length <= 100)) &&
      (undefined === input.lastName ||
        ('string' === typeof input.lastName && input.lastName.length <= 100));
    const _vo0 = (input: any, _path: string, _exceptionable: boolean = true): boolean =>
      [
        ('string' === typeof input.email &&
          (__typia_transform__isFormatEmail._isFormatEmail(input.email) ||
    ...
    const __is = (input: any): input is SignupCredentials =>
      'object' === typeof input && null !== input && _io0(input);
    let errors: any;
    let _report: any;
    return (input: any): import('typia').IValidation<SignupCredentials> => {
      if (false === __is(input)) {
        errors = [];
        _report = (__typia_transform__validateReport._validateReport as any)(errors);
        ((input: any, _path: string, _exceptionable: boolean = true) =>
